...
export default class Point {
    ...
    updatePoint(delta, gravity) {
        ...
        if (!this.locked) {
            ...
            const vx = (this.position.x - this.prevPosition.x) * friction;
            const vy = (this.position.y - this.prevPosition.y) * friction;
            const vz = (this.position.z - this.prevPosition.z) * friction;
